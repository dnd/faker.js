...
function Random (faker, seed) {
   ...
   * @param {mixed} options defaults to 1
   * @param {number} options.min minimum length defaults to 1
   * @param {number} options.max maximum length defaults to 99
   */
  this.alpha = function alpha(options) {
    if (typeof options === "undefined") {
      ...
      count = faker.random.number(options);
    }
